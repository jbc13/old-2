...
```{r}
prod1_file <- str_replace("../output/tdi200820164ys-qcID.rds", "ID",as.character(2))
prod1_file
```
...
```{r}
saveRDS(meta_qc, "../output/tdi200820164ys-qc2-metadata.rds")
# read_rds('/home/jonas/rpackages/jbc-ic/output/tdi200820164ys-qc2-metadata.rds')
```
...
perc <- round(s[['tot']]/s[['size']] * 100, 1)

a2 <- select(s,c('site','qc','tot'))
